import { $mobx, _getAdministration, _interceptReads, action, computed, extendObservable, getAtom, intercept, isComputedProp, isObservableArray, isObservableProp, observable, observe, reaction, runInAction, values } from 'mobx';
